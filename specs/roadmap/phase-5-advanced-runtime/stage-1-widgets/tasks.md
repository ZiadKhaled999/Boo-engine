...
**Tests**
1. `Create widget support success` — setup valid config + payload; invoke method; expect `ok=true` and expected side-effect.
2. `Create widget support validation failure` — send malformed payload; expect `VALIDATION_ERROR` and no side-effect.
3. `Create widget support permission denied` — remove permission or deny OS prompt; expect `PERMISSION_DENIED`.
...
**Tests**
1. `Update widget state success` — setup valid config + payload; invoke method; expect `ok=true` and expected side-effect.
2. `Update widget state validation failure` — send malformed payload; expect `VALIDATION_ERROR` and no side-effect.
3. `Update widget state permission denied` — remove permission or deny OS prompt; expect `PERMISSION_DENIED`.
...
**Tests**
1. `Handle widget interactions success` — setup valid config + payload; invoke method; expect `ok=true` and expected side-effect.
2. `Handle widget interactions validation failure` — send malformed payload; expect `VALIDATION_ERROR` and no side-effect.
3. `Handle widget interactions permission denied` — remove permission or deny OS prompt; expect `PERMISSION_DENIED`.
...
**Tests**
1. `Sync widget data success` — setup valid config + payload; invoke method; expect `ok=true` and expected side-effect.
2. `Sync widget data validation failure` — send malformed payload; expect `VALIDATION_ERROR` and no side-effect.
3. `Sync widget data permission denied` — remove permission or deny OS prompt; expect `PERMISSION_DENIED`.
